  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        {[...Array(20)].map((_, i) => (
          <div
            ...
            style={{
              ...
              animation: `networkPulse ${3 + (i % 3)}s ease-in-out infinite ${i * 0.2}s`,
            }}
          >
            <div className="absolute inset-0 bg-blue-400 rounded-full animate-ping" style={{ opacity: 0.3 }} />
          </div>
        ))}
          ...
          {[...Array(15)].map((_, i) => {
            ...
            return (
              <line
                ...
                strokeDasharray="5,5"
                style={{
                  animation: `networkFlow ${8 + (i % 4) * 2}s ease-in-out infinite ${i * 0.5}s`,
                }}
              />
            )
          })}
        ...
        {[...Array(8)].map((_, i) => (
          <div
            ...
            style={{
              ...
              opacity: 0.1,
              animation: `securityFloat ${20 + i * 3}s ease-in-out infinite ${i * 2}s`,
            }}
          >
        ...
        >
          <div
            className="absolute inset-20 border border-blue-400 rounded-full animate-pulse"
            style={{ opacity: 0.2 }}
          />
        </div>
      </div>
      ...
      {/* Header */}
      <header
        className="relative z-50 bg-slate-900 backdrop-blur-xl border-b border-slate-700"
        style={{ backgroundColor: "rgba(15, 23, 42, 0.9)" }}
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="relative">
              <img src="/images/darvin-logo.png" alt="Darvin Cyber Defense Logo" className="w-12 h-12 object-contain" />
            ...
            <div>
              ...
              <div className="text-xs text-cyan-400" style={{ letterSpacing: "0.1em" }}>
                CYBER DEFENSE
              </div>
            </div>
          </div>
          ...
          <Button className="shadow-lg" style={{ boxShadow: "0 4px 14px 0 rgba(37, 99, 235, 0.25)" }}>
            Book a Demo
          </Button>
        </div>
      </header>
      ...
      <section className="relative z-40 py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <Badge
                className="mb-6 bg-blue-600 text-white border border-blue-500 backdrop-blur-sm"
                style={{ backgroundColor: "rgba(37, 99, 235, 0.2)", borderColor: "rgba(59, 130, 246, 0.3)" }}
              >
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed" style={{ maxWidth: "36rem" }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button size="lg" className="shadow-lg" style={{ boxShadow: "0 4px 14px 0 rgba(37, 99, 235, 0.25)" }}>
                  Book a Demo
                </Button>
                <Button
                  size="lg"
            ...
            <div className="relative flex justify-center items-center" style={{ height: "500px" }}>
              <div className="relative" style={{ perspective: "1500px" }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    animation: "globe3DRotate 60s ease-in-out infinite",
                  }}
                >
                  {/* 3D Globe Core */}
                  <div
                    ...
                    >
                      ...
                      <div className="absolute inset-0 rounded-full">
                        ...
                        {[...Array(12)].map((_, i) => (
                          <div
                            key={`lng-${i}`}
                            className="absolute border-l border-cyan-400 rounded-full"
                            style={{
                              left: "50%",
                              top: "10%",
                              bottom: "10%",
                          ...
                          {[...Array(3)].map((_, i) => (
                            <div
                              ...
                              style={{
                                ...
                                animation: `hologramScan ${2 + i * 0.5}s ease-in-out infinite ${i * 0.3}s`,
                      ...
                      {/* Globe Highlight */}
                      <div
                        className="absolute top-6 left-6 w-12 h-12 rounded-full blur-lg"
                      ...
                      {[...Array(12)].map((_, i) => (
                        <div
                          ...
                          style={{
                            ...
                            animation: `dataStream ${3 + Math.random() * 2}s ease-in-out infinite ${i * 0.2}s`,
                          }}
                        />
                      ))}
                    </div>
                ...
                {[160, 200, 240].map((radius, ringIndex) => (
                  <div
                    ...
                    style={{
                      ...
                      animation: `orbitRing ${15 + ringIndex * 3}s cubic-bezier(0.4, 0, 0.6, 1) infinite ${ringIndex * 1}s`,
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        marginLeft: "-200px",
                        marginTop: "-200px",
                        animation: "satelliteOrbit 60s linear infinite",
                        animationDelay: `${-(startAngle / 360) * 60}s`,
                      }}
                    >
                      <div
                        className="absolute"
                        style={{
                          ...
                          animation: "satelliteCounterRotate 60s linear infinite",
                          animationDelay: `${-(startAngle / 360) * 60}s`,
                        }}
                      >
                        <div
                        ...
                        >
                          ...
                          <div
                            className="absolute inset-0 transition-all duration-500 rounded-full border-4"
                            style={{
                              borderColor: "rgba(255, 255, 255, 0.2)",
                              animation:
                                activeService === index
                                  ? "stationGlow 4s cubic-bezier(0.4, 0, 0.6, 1) infinite"
                                  : "none",
                          ...
                          >
                            ...
                            {/* Service Label */}
                            <div
                              className="absolute text-xs font-bold text-white bg-black px-2 py-1 rounded whitespace-nowrap"
                              style={{
                  ...
                  <div key={asteroid.id}>
                    {!asteroid.intercepted ? (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            ...
                            animation: `asteroidSpin ${2 + Math.random()}s linear infinite`,
                        ...
                        {[...Array(3)].map((_, i) => (
                          <div
                            ...
                            style={{
                              ...
                              animation: `asteroidTrail ${0.5 + i * 0.2}s ease-out infinite ${i * 0.1}s`,
                            }}
                          />
                        ))}
                      ...
                      >
                        ...
                        {[...Array(6)].map((_, i) => (
                          <div
                            ...
                            style={{
                              ...
                              animation: `particleFloat 1s ease-out ${i * 0.1}s`,
                            }}
                          />
                        ))}
                        ...
                        {asteroid.interceptorPlanet !== undefined && (
                          <div
                            ...
                            style={{
                              ...
                              animation: "defenseBeam 0.5s ease-out",
                        ...
                        <div
                          className="absolute text-xs font-bold text-green-400 bg-black px-2 py-1 rounded whitespace-nowrap"
                          style={{
                ...
                {[...Array(20)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      animation: `particleFloat ${4 + Math.random() * 3}s ease-in-out infinite ${i * 0.2}s`,
                    }}
                  />
                ))}
                  ...
                  {services.map((service, i) => {
                    ...
                    return (
                      <line
                        ...
                        opacity="0.9"
                        style={{
                          animation: "networkFlow 2s ease-in-out infinite",
              ...
              <div className="absolute bottom-0 left-1/2" style={{ transform: "translateX(-50%) translateY(2rem)" }}>
                <Card
                  className="bg-slate-800 backdrop-blur-xl border-slate-700 shadow-2xl"
                  style={{ backgroundColor: "rgba(30, 41, 59, 0.95)" }}
                >
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-3">
                      <div
                        className="w-3 h-3 bg-cyan-500 rounded-full animate-pulse shadow-lg"
      ...
      {/* Trust Section */}
      <section
        className="relative z-40 py-16 bg-slate-800 backdrop-blur-xl"
        style={{ backgroundColor: "rgba(30, 41, 59, 0.5)" }}
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Enterprises and MSSPs Rely on Darvin</h2>
            <p className="text-lg text-slate-300" style={{ maxWidth: "32rem", margin: "0 auto" }}>
              Trusted by security teams at leading organizations worldwide
            </p>
          </div>

          {/* Company Logos */}
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center" style={{ opacity: 0.6 }}>
            {[
              ...
              <div key={index} className="text-center">
                <div
                  className="w-16 h-16 bg-slate-700 rounded-lg flex items-center justify-center mx-auto mb-2 backdrop-blur-sm border border-slate-600"
                  style={{ backgroundColor: "rgba(51, 65, 85, 0.5)", borderColor: "rgba(71, 85, 105, 0.3)" }}
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div
              className="text-center p-6 bg-slate-800 backdrop-blur-sm rounded-xl border border-slate-700"
              style={{ backgroundColor: "rgba(30, 41, 59, 0.5)" }}
            >
      ...
      <section id="platform" className="relative z-40 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge
              className="mb-4 bg-blue-600 text-white border border-blue-500 backdrop-blur-sm"
              style={{ backgroundColor: "rgba(37, 99, 235, 0.2)", borderColor: "rgba(59, 130, 246, 0.3)" }}
            >
            ...
            <p className="text-xl text-slate-300" style={{ maxWidth: "48rem", margin: "0 auto" }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="bg-slate-800 border-slate-700 hover:bg-slate-800 transition-all duration-300 group backdrop-blur-xl"
                style={{
                ...
                onMouseLeave={() => {
                  const card = document.querySelector(`[data-service-card="${index}"]`)
                  if (card) {
                    card.style.backgroundColor = "rgba(30, 41, 59, 0.5)"
                  }
                }}
              ...
              >
                <CardHeader>
                  <div
                    className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600 transition-colors backdrop-blur-sm"
                ...
                <CardContent>
                  <Button
                    variant="ghost"
                    className="text-blue-400 hover:text-blue-300 p-0 font-medium hover:bg-transparent"
                    style={{ height: "auto" }}
                  >
                    Learn more
      ...
      {/* Why Choose Darvin */}
      <section
        className="relative z-40 py-20 bg-slate-800 backdrop-blur-xl"
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <Badge
                className="mb-6 bg-green-600 text-white border border-green-500 backdrop-blur-sm"
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div
                      className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center backdrop-blur-sm"
                      style={{ backgroundColor: "rgba(37, 99, 235, 0.2)", flexShrink: 0 }}
                    >
            ...
            <div className="relative">
              <div
                className="bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 p-8 backdrop-blur-xl"
              ...
              >
                ...
                <div className="space-y-4">
                  <div
                    className="flex justify-between items-center p-3 bg-green-600 rounded-lg backdrop-blur-sm border border-green-500"
                    style={{ backgroundColor: "rgba(34, 197, 94, 0.2)", borderColor: "rgba(34, 197, 94, 0.2)" }}
                  >
                  ...
                  <div
                    className="flex justify-between items-center p-3 bg-blue-600 rounded-lg backdrop-blur-sm border border-blue-500"
                    style={{ backgroundColor: "rgba(37, 99, 235, 0.2)", borderColor: "rgba(59, 130, 246, 0.2)" }}
                  >
                  ...
                  <div
                    className="flex justify-between items-center p-3 bg-slate-700 rounded-lg backdrop-blur-sm border border-slate-600"
                    style={{ backgroundColor: "rgba(51, 65, 85, 0.5)", borderColor: "rgba(71, 85, 105, 0.3)" }}
                  >
      ...
      {/* CTA Section */}
      <section className="relative z-40 py-20" style={{ background: "linear-gradient(to right, #0f172a, #1e293b)" }}>
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Strengthen Your Cyber Defense?</h2>
          <p className="text-xl text-slate-300 mb-8" style={{ maxWidth: "32rem", margin: "0 auto 2rem auto" }}>
      ...
      {/* Footer */}
      <footer
        className="relative z-40 bg-slate-900 border-t border-slate-700 py-12 backdrop-blur-xl"
        style={{ backgroundColor: "rgba(15, 23, 42, 0.8)" }}
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <img src="/images/darvin-logo.png" alt="Darvin Cyber Defense Logo" className="w-8 h-8 object-contain" />
              <div>
